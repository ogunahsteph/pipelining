...
with DAG(
    ...
    dag.doc_md = """
    ####DAG SUMMARY
    Extracts data from MIFOS and adds to ubuntu.jubilee.loans_fact_table following SCD type 2

    #### Actions
    <ol>
    <li>Extract from mifostenant-jubilee.m_loan</li>
    <li>Check for existing loan instances in ubuntu.jubilee.loans_fact_table</li>
    <li>Update existing instances in ubuntu.jubilee.loans_fact_table</li>
    <li>Insert latest loan details in ubuntu.jubilee.loans_fact_table</li>
    </ol>
    """
    ...
    def extract_load_loans_fact_table(**context) -> None:
        ...
        :return: None
        """
        el_loans_fact_table(mifos_tenant='jubilee', warehouse_schema='jubilee')
