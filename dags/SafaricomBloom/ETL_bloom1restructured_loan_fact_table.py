...
with DAG(
        'ETL_bloom1_restructured_loans_fact_table',
        default_args=default_args,
        catchup=False,
        schedule_interval=None,
        start_date=datetime.datetime(2023, 6, 14, 9, 48, tzinfo=local_tz),
    ...
    The data pipeline is triggered by the pipeline [ETL_bloom_dimensions](https://airflow.asantefsg.com/data-pipelines/dags/ETL_bloom_loans_fact_table/grid)
       ...
       The data is located in the mifostenant-bloom1restructure.m_loan table and includes loans specific to Safaricom Bloom version 1.0.
    ...
    def remove_warehouse_duplicates(**context):
        ...
        remove_loan_facts_table_duplicates(
            schema='bloomlive',
            filters="and bloom_version = 'bloom1_restructured'"
        )
